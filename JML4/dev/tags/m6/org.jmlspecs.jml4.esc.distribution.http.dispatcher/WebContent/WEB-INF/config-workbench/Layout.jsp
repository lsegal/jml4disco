<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.io.PrintWriter,org.jmlspecs.jml4.esc.distribution.http.dispatcher.config.servlets.Presentation,org.jmlspecs.jml4.esc.distribution.servers.vcprogram.VcCache"%>
...
<%
		if(VcCache.isEnabled()) {
			%>
			<li><a href='DisableCaching' title=''>Disable Caching</a></li>
			<%	
		}
		else {
			%>
			<li><a href='EnableCaching' title=''>Enable Caching</a></li>
			<%	
		}
%>
	</ul>
