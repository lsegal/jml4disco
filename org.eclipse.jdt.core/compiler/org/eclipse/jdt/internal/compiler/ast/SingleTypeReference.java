...
public class SingleTypeReference extends TypeReference {
	...
	// <jml-start id="nnts" />
	public TypeReference copyDims(int dim, Nullity[]  elemNullity, Nullity nullity, long ownershipModifiers) {
		//return a type reference copy of me with some dimensions
		//warning : the new type ref has a null binding
		return new JmlArrayTypeReference(token, dim,(((long)sourceStart)<<32)+sourceEnd, elemNullity, nullity, ownershipModifiers);
	}
	// <jml-end id="nnts" />
