...
void setSourceStart(int sourceStart);
	 ...
	 * Null type system
	 */
	int DereferenceNullField = TypeRelated + FieldRelated + 820;
	int MethodReturnsNull = TypeRelated + MethodRelated + 821;
	int AssignNull = TypeRelated + Internal + 822;
	int SendNull = TypeRelated + MethodRelated + 823;
	int SendToNull = TypeRelated + MethodRelated + 824;
    int DereferenceNull = TypeRelated + 825;
    int UninitializedBlankNonNullField = TypeRelated + FieldRelated + 826;
    int AttemptBroadenReturnNullity = TypeRelated + MethodRelated + 827;
    int AttemptNarrowParameterNullity = TypeRelated + MethodRelated + 828;
    int TypeReferenceNotExplicitlyMarkedWithNullity = TypeRelated + 829;
    // <jml-end id="2" />
    
    // <jml-end id="checkSupersNullity" />
    int IncompatibleReturnTypeNullity = MethodRelated + 830;
	int IncompatibleParameterNullity = MethodRelated + 831;
    // <jml-end id="checkSupersNullity" />

    // <jml-start id="modifiers" />
    int InvalidModifier=835;
    int DuplicateModifier=836;
    ...
    int JmlEsc2Caution=840;
    int JmlEsc2Warning=841;
    int JmlEsc2Error=842;
    int JmlEsc2Fatal=843;
    // <jml-end id="escsupport1" />
    
    // <jml-start id="set-comprehensions" />
    int IllegalExpressionForSetMembership=844;
    int IllegalTypeForSetComprehension=845;
    // <jml-end id="set-comprehensions" />
    
    // <jml-start id="assignable" />
    int InvalidUsageOfThis = Syntax + Internal + 846;
    int InvalidStoreRefUsage = Syntax + Internal + 847;
