...
public void generateCode(BlockScope currentScope, CodeStream codeStream) {
	...
	if (this.initialization != null
		...
		// <jml-start id="2" />
		this.generateTestForNullity(currentScope, codeStream);
		// <jml-end id="2" />
		// store into field
		if (isStatic) {
	...
	// <jml-start id="2" />
		...
		this.generateTestForNullityUninitedConst(currentScope, codeStream);
	// <jml-end id="2" />
	}
...
// <jml-start id="2" />
protected void generateTestForNullity(BlockScope currentScope,
