...
public class SetNumberOfSimplifyProcesses extends FrontCommand {
	...
	public void execute(CommandInput arg) throws FrontControllerException {
		try {
			...
			if(max_process_string!=null) {
				...
				SimplifyProcessPool.getInstance().setMAX_PROCESS(max_process);
				arg.setAttribute("out", "The number of Simplify processes has been set to "+max_process);
			}
		}
		catch(Exception e) {
