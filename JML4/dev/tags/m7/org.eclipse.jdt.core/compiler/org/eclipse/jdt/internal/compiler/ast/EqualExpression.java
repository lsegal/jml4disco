...
public class EqualExpression extends BinaryExpression {
		...
		switch (nullStatus) {
			case FlowInfo.NULL :
				...
				if (((this.bits & OperatorMASK) >> OperatorSHIFT) == EQUAL_EQUAL
				 || ((this.bits & OperatorMASK) >> OperatorSHIFT) == JML_EQUIV) {
				// <jml-end id="implicationOperators" />
					...
					// <jml-start id="?" />
					if (!scope.compilerOptions().jmlEnabled || !flowInfo.isDefinitelyNonNull(local))
					// <jml-start id="?" />
					...
					// <jml-start id="?" />
					if (!scope.compilerOptions().jmlEnabled || !flowInfo.isDefinitelyNull(local))
					// <jml-start id="?" />
	...
	public FlowInfo analyseCode(BlockScope currentScope, FlowContext flowContext, FlowInfo flowInfo) {
		...
		if (((bits & OperatorMASK) >> OperatorSHIFT) == EQUAL_EQUAL
		 || ((bits & OperatorMASK) >> OperatorSHIFT) == JML_EQUIV) {
		// <jml-end id="implicationOperators" />
	...
	public final void computeConstant(TypeBinding leftType, TypeBinding rightType) {
		if ((this.left.constant != Constant.NotAConstant) && (this.right.constant != Constant.NotAConstant)) {
			...
			if (((this.bits & OperatorMASK) >> OperatorSHIFT) == NOT_EQUAL
			 || ((this.bits & OperatorMASK) >> OperatorSHIFT) == JML_NOT_EQUIV)
			// <jml-end id="implicationOperators" />
...
//				}
	...
	public void generateNonBooleanEqual(BlockScope currentScope, CodeStream codeStream, boolean valueRequired) {
		// <jml-start id="implicationOperators" />
		//@ assert (this.bits & OperatorMASK) >> OperatorSHIFT) == JML_EQUIV;
		//@ assert (this.bits & OperatorMASK) >> OperatorSHIFT) == JML_NOT_EQUIV;
		// <jml-end id="implicationOperators" />
		boolean isEqualOperator = ((this.bits & OperatorMASK) >> OperatorSHIFT) == EQUAL_EQUAL;
