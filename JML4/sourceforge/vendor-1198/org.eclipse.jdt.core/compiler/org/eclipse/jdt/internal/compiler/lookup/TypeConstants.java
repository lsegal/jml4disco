...
public interface TypeConstants {
	...
	char[]   JML_ORG        = "org".toCharArray(); //$NON-NLS-1$
	char[]   JMLSPECS       = "jmlspecs".toCharArray(); //$NON-NLS-1$
	char[]   JML4           = "jml4".toCharArray(); //$NON-NLS-1$
	char[]   JML_RUNTIME    = "runtime".toCharArray(); //$NON-NLS-1$
	char[]   JML_ANNOTATION = "annotation".toCharArray(); //$NON-NLS-1$
	char[][] JML_ANNOTATION_PKG = {JML_ORG, JMLSPECS, JML_ANNOTATION};
	char[][] JML_RUNTIME_ANNOTATION = {JML_ORG, JMLSPECS, JML4, JML_RUNTIME, JML_ANNOTATION};
	// char[]   JML_ERROR      = "error".toCharArray(); //$NON-NLS-1$
	// char[][] JML_RUNTIME_ERROR      = {JML_ORG, JMLSPECS, JML4, JML_RUNTIME, JML_ERROR};

	char[] JML_ANNOTATION_CODE_BIGINT_MATH = "CodeBigintMath".toCharArray(); //$NON-NLS-1$
	char[] JML_ANNOTATION_CODE_JAVA_MATH = "CodeJavaMath".toCharArray(); //$NON-NLS-1$
	char[] JML_ANNOTATION_CODE_SAFE_MATH = "CodeSafeMath".toCharArray(); //$NON-NLS-1$
	char[] JML_ANNOTATION_GHOST = "Ghost".toCharArray(); //$NON-NLS-1$
	char[] JML_ANNOTATION_HELPER = "Helper".toCharArray(); //$NON-NLS-1$
	char[] JML_ANNOTATION_INSTANCE = "Instance".toCharArray(); //$NON-NLS-1$
	char[] JML_ANNOTATION_MODEL ="Model".toCharArray(); //$NON-NLS-1$
	// NONNULL and NULLABLE are not currently used
	char[] JML_ANNOTATION_NONNULL ="NonNull".toCharArray(); //$NON-NLS-1$
	char[] JML_ANNOTATION_NULLABLE ="Nullable".toCharArray(); //$NON-NLS-1$
	char[] JML_ANNOTATION_PEER ="Peer".toCharArray(); //$NON-NLS-1$
	char[] JML_ANNOTATION_PURE ="Pure".toCharArray(); //$NON-NLS-1$
	char[] JML_ANNOTATION_READONLY ="Readonly".toCharArray(); //$NON-NLS-1$
	char[] JML_ANNOTATION_REP ="Rep".toCharArray(); //$NON-NLS-1$
	char[] JML_ANNOTATION_SPEC_BIGINT_MATH = "SpecBigintMath".toCharArray(); //$NON-NLS-1$
	char[] JML_ANNOTATION_SPEC_JAVA_MATH = "SpecJavaMath".toCharArray(); //$NON-NLS-1$
	char[] JML_ANNOTATION_SPEC_PROTECTED ="SpecProtected".toCharArray(); //$NON-NLS-1$
	char[] JML_ANNOTATION_SPEC_PUBLIC ="SpecPublic".toCharArray(); //$NON-NLS-1$
	char[] JML_ANNOTATION_SPEC_SAFE_MATH = "SpecSafeMath".toCharArray(); //$NON-NLS-1$
	char[] JML_ANNOTATION_UNINITIALIZED = "Uninitialized".toCharArray(); //$NON-NLS-1$

	char[][] JML_ANNOTATION_TYPE_CODE_BIGINT_MATH = {JML_ORG, JMLSPECS, JML_ANNOTATION, JML_ANNOTATION_CODE_BIGINT_MATH};
	char[][] JML_ANNOTATION_TYPE_CODE_JAVA_MATH = {JML_ORG, JMLSPECS, JML_ANNOTATION, JML_ANNOTATION_CODE_JAVA_MATH};
	char[][] JML_ANNOTATION_TYPE_CODE_SAFE_MATH = {JML_ORG, JMLSPECS, JML_ANNOTATION, JML_ANNOTATION_CODE_SAFE_MATH};
	char[][] JML_ANNOTATION_TYPE_GHOST = {JML_ORG, JMLSPECS, JML_ANNOTATION, JML_ANNOTATION_GHOST};
	char[][] JML_ANNOTATION_TYPE_HELPER = {JML_ORG, JMLSPECS, JML_ANNOTATION, JML_ANNOTATION_HELPER};
	char[][] JML_ANNOTATION_TYPE_INSTANCE = {JML_ORG, JMLSPECS, JML_ANNOTATION, JML_ANNOTATION_INSTANCE};
	char[][] JML_ANNOTATION_TYPE_MODEL = {JML_ORG, JMLSPECS, JML_ANNOTATION, JML_ANNOTATION_MODEL};
	// NONNULL and NULLABLE would go here
	char[][] JML_ANNOTATION_TYPE_PEER = {JML_ORG, JMLSPECS, JML_ANNOTATION, JML_ANNOTATION_PEER};
	char[][] JML_ANNOTATION_TYPE_PURE = {JML_ORG, JMLSPECS, JML_ANNOTATION, JML_ANNOTATION_PURE};
	char[][] JML_ANNOTATION_TYPE_READONLY = {JML_ORG, JMLSPECS, JML_ANNOTATION, JML_ANNOTATION_READONLY};
	char[][] JML_ANNOTATION_TYPE_REP = {JML_ORG, JMLSPECS, JML_ANNOTATION, JML_ANNOTATION_REP};
	char[][] JML_ANNOTATION_TYPE_SPEC_BIGINT_MATH = {JML_ORG, JMLSPECS, JML_ANNOTATION, JML_ANNOTATION_SPEC_BIGINT_MATH};
	char[][] JML_ANNOTATION_TYPE_SPEC_JAVA_MATH = {JML_ORG, JMLSPECS, JML_ANNOTATION, JML_ANNOTATION_SPEC_JAVA_MATH};
	char[][] JML_ANNOTATION_TYPE_SPEC_PROTECTED = {JML_ORG, JMLSPECS, JML_ANNOTATION, JML_ANNOTATION_SPEC_PROTECTED};
	char[][] JML_ANNOTATION_TYPE_SPEC_PUBLIC = {JML_ORG, JMLSPECS, JML_ANNOTATION, JML_ANNOTATION_SPEC_PUBLIC};
	char[][] JML_ANNOTATION_TYPE_SPEC_SAFE_MATH = {JML_ORG, JMLSPECS, JML_ANNOTATION, JML_ANNOTATION_SPEC_SAFE_MATH};
	char[][] JML_ANNOTATION_TYPE_UNINITIALIZED = {JML_ORG, JMLSPECS, JML_ANNOTATION, JML_ANNOTATION_UNINITIALIZED};
