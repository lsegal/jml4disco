...
public class CompilerOptions {
	...
	// <jml-start id="nnts" />
	// FIXME: use suboptions ...
	public CompilerOptions subOptions = null;

	public boolean jmlDefaultIsNonNull = true;
	public boolean jmlRacEnabled = false;
	public boolean jmlNullityCountsEnabled = false;
	public boolean jmlEnabled = false;
	public boolean jmlDbcEnabled = false;
	public boolean useNonNullTypeSystem() {
		return jmlEnabled
			&& ((warningThreshold | errorThreshold) & JmlCompilerOptions.ReportNonNullTypeSystem) != 0;
 	}
	public String jmlSpecPath = ""; //$NON-NLS-1$
	// <jml-end id="nnts" />
	...
	public boolean jmlEsc2Enabled = false;
	public boolean jmlEsc2EchoOutputEnabled = false; 
	public String jmlEsc2CommandLineArgs = ""; //$NON-NLS-1$
	public String jmlSimplifyPath = ""; //$NON-NLS-1$
	// <jml-end id="escsupport1" />

	// <jml-start id="esc4support" />
	public boolean jmlEscEnabled = false;
	public boolean jmlEscGovernsRac = false;
	...
	public boolean	jml2CheckerEnabled = false;
	public boolean	jml2CompilerEnabled = false;
	//jml-start id="jml2toolsupport"
	...
	public CompilerOptions(){
		...
		CompilerExtensionManager.initCompilerOptions(this);
	...
	public Map getMap() {
      ...
      // <jml-start id="extension" />
		CompilerExtensionManager.getOptionsMap(this,optionsMap);
	...
	public static String optionKeyFromIrritant(long irritant) {
        ...
        // <jml-start id="extension" />
        String emResult = CompilerExtensionManager.optionKeyFromIrritant(irritant);
		if(emResult != null)
			return emResult;
        // <jml-end id="extension" />
		return null;
	...
	public void set(Map optionsMap) {
	    ...
	    // <jml-start id="extension" />
		CompilerExtensionManager.setOptionsMap(this,optionsMap);
        // <jml-end id="extension" />
	...
	public String toString() {
		...
		// <jml-start id="extension" />
		CompilerExtensionManager.optionsToBuffer(this,buf);
		// <jml-end id="extension" />
		return buf.toString();
	}
	...
	public static String[] warningOptionNames() {
		String[] result = {
			...
			// <jml-start id="nnts" />        
			// FIXME: THis has to be added to the array from EScJava2BatchWrapper
			// OPTION_ReportNonNullTypeSystem,
			"org.eclipse.jdt.core.compiler.problem.nonNullTypeSystem", //$NON-NLS-1$
			// OPTION_ExplicitNullityAnnotations,
			"org.eclipse.jdt.core.compiler.problem.explicitNullityAnnotations", //$NON-NLS-1$
			// <jml-end id="nnts" />
	...
	public static String warningTokenFromIrritant(long irritant) {
        ...
        // <jml-start id="extension" />
        String emResult = CompilerExtensionManager.warningTokenFromIrritant(irritant);
        if(emResult != null)
			return emResult;
        // <jml-end id="extension" />
		return null;
	...
	public final static String[] warningTokens = {
		...
		"nls", //$NON-NLS-1$
		"null", //$NON-NLS-1$
		// FIXME add this in JmlCompilerExtension
		// <jml-start id="nnts" />
		"nnts",  //$NON-NLS-1$
		"explicitNullity",  //$NON-NLS-1$
		// <jml-end id="nnts" />
	...
	public static long warningTokenToIrritants(String warningToken) {
        ...
        // <jml-start id="extension" />
        long emResult = CompilerExtensionManager.warningTokenToIrritant(warningToken);
        if(emResult != 0)
			return emResult;
        // <jml-end id="extension" />
		return 0;
