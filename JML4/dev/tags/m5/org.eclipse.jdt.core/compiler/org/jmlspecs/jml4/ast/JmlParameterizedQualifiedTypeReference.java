...
public class JmlParameterizedQualifiedTypeReference extends
		ParameterizedQualifiedTypeReference implements JmlTypeReference {

	private Nullity nullity;
	private final long ownershipModifiers;
	private final Nullity[] elemNullities;
	
	public JmlParameterizedQualifiedTypeReference(char[][] tokens,
			TypeReference[][] typeArguments, int dim, long[] positions, 
			Nullity nullity, 
			Nullity[] elemNullities, 
			long ownershipModifiers) {
		super(tokens, typeArguments, dim, positions);
	...
	public TypeReference copyDims(int dim, Nullity[] elemNullities, Nullity nullity, long ownershipModifiers) {
		return new JmlParameterizedQualifiedTypeReference(this.tokens, this.typeArguments, dim, this.sourcePositions, nullity, elemNullities, this.ownershipModifiers);
	}	
