...
void checkAndSetImports() {
	...
	int defaultImportsLength = defaultImports.length;
	// numberOfImports += defaultImportsLength-1; // 2008-04-10: commenting out because I think that this statement is unnecessary.
	for (int i = 0; i < defaultImportsLength; i++) {
		resolvedImports[i] = defaultImports[i];
	}
	int index = defaultImportsLength;
