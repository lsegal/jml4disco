...
public class Compiler implements ITypeRequestor, ProblemSeverities {
	...
	// <jml-start id="7" />
	private final /*@non_null*/ JmlSourceLookup jmlSourceLookup;
	public final /*@non_null*/ JmlBinaryLookup jmlBinaryLookup;
	// <jml-end id="7" />
	...
	public Compiler(
		...
		// <jml-start id="7" />
		// these initialization can't be moved to their declarations because the 
		// constructors depend on other fields in this having been initialized.
		this.jmlSourceLookup = new JmlSourceLookup(this);
		this.jmlBinaryLookup = new JmlBinaryLookup(this.jmlSourceLookup);
		// <jml-end id="7" />
		initializeParser();
	}
...
//		    System.out.println();
	...
	public void process(CompilationUnitDeclaration unit, int i) {
		...
		if (this.options.jmlEnabled || this.options.jml2CheckerEnabled || this.options.jml2CompilerEnabled)
			CompilerExtensionManager.preCodeGeneration(this, unit);
		...
		if (this.options.jmlEnabled && this.options.jmlNullityCountsEnabled) {
			CompilationUnitScope scope = null; //new CompilationUnitScope(unit, this.lookupEnvironment));
