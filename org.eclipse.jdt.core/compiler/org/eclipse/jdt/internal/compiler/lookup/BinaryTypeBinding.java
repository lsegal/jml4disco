...
// <jml-start id="stopInfLoop" />
// TODO: do we really need this flag?  Could we not simply test whether typeDeclaration is null?
public boolean jmlBinaryLookupDecorateBindingWithJmlCalled = false;
public TypeDeclaration typeDeclaration = null;
/*@ invariant tyepDeclaration != null ==> jmlBinaryLookupDecorateBindingWithJmlCalled */

public FieldBinding getField(char[] fieldName) {
	FieldBinding field = getField(fieldName, true/*resolve*/);
	if (field.sourceField() == null) {
		if(environment.typeRequestor instanceof org.eclipse.jdt.internal.compiler.Compiler) {
			org.eclipse.jdt.internal.compiler.Compiler c = (org.eclipse.jdt.internal.compiler.Compiler) environment.typeRequestor;
			ReferenceBinding b = field.declaringClass;
			c.jmlBinaryLookup.mergeWithSourceAndSpec(environment.problemReporter, b);
		}
	}
	return field;
}
