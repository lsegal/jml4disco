...
public class MethodBinding extends Binding {
	...
	public long tagBits;
	// <jml-start id="2" />
	public AbstractMethodDeclaration methodDeclaration = null;
	// <jml-end id="2" />
	// <jml-start id="checkSupersNullity">
	public MethodBinding[] overriddenInheritedMethods = null;
...
// <jml-start id="2" />
public MethodBinding(int modifiers, TypeBinding[] parameters, ReferenceBinding[] thrownExceptions, ReferenceBinding declaringClass, AbstractMethodDeclaration method) {
	this(modifiers, parameters, thrownExceptions, declaringClass);
	...
	if ((originalMethod.tagBits & TagBits.DefaultValueResolved) == 0) {
		...
		if (originalMethod.declaringClass instanceof SourceTypeBinding) {
			...
			if (sourceType.scope != null) {
				AbstractMethodDeclaration decl = originalMethod.sourceMethod();
				if (decl != null && decl.isAnnotationMethod()) {
					decl.resolve(sourceType.scope);
				}
			}
		}
...
public AbstractMethodDeclaration sourceMethod() {
  ...
  if (this.declaringClass instanceof SourceTypeBinding) {
	...
	// <jml-start id="2" />
    if (sourceType == null || sourceType.scope == null || 
    	sourceType.scope.referenceContext == null || 
    	sourceType.scope.referenceContext.methods == null)
    	return null;
   // <jml-start id="2" />
  ...
  } else if (this.declaringClass instanceof BinaryTypeBinding) {
			BinaryTypeBinding binaryTypeBinding = (BinaryTypeBinding) this.declaringClass;
			return JmlBinaryLookup.getDeclaration(this, binaryTypeBinding);
  }
	// <jml-end id="2" />
	return null;		
}
