...
public class SugaredContinueStatement extends SugaredStatement {

	public final String label;
	public SugaredContinueStatement(String label, int sourceStart) {
		super(sourceStart);
	...
	public String toString() {
		return "[SugaredContinue: "+this.label+"]";   //$NON-NLS-1$//$NON-NLS-2$
	}
}
