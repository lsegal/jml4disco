...
public class VcConditionalExpression extends VC {
	...
	public  VC condition;
	public  VC valueIfTrue;
	public  VC valueIfFalse;

	public VcConditionalExpression () {}
	
	public void readExternal(ObjectInput in) throws IOException,
	ClassNotFoundException {
		super.readExternal(in);
		this.condition = readVc(in);
		this.valueIfTrue = readVc(in);
		this.valueIfFalse = readVc(in);
	}

	public void writeExternal(ObjectOutput out) throws IOException {
		super.writeExternal(out);
		this.condition.writeVc(out);
		this.valueIfTrue.writeVc(out);
		this.valueIfFalse.writeVc(out);
	}
	...
	/*package*/ VC inline(Map map) {
		...
		if (this.condition.equals(conds) && this.valueIfTrue.equals(trues) && this.valueIfFalse.equals(falses))
			return this;
