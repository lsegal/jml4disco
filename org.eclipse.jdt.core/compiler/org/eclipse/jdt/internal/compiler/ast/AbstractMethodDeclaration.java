...
public abstract class AbstractMethodDeclaration
	...
	public void generateCode(ClassFile classFile) {
		...
		if ((!this.binding.isNative()) && (!this.binding.isAbstract())) {
			...
			// <jml-start id="2" />
			generateChecksForPrecondition(this.scope, codeStream);
			// <jml-end id="2" />			
			...
			if ((this.bits & ASTNode.NeedFreeReturn) != 0) {
				// <jml-start id="0a1" />
				generateChecksForPostcondition(this.scope, codeStream);
				// <jml-end id="0a1" />
				codeStream.return_();
			}
	...
	// <jml-start id="0a1" />
	protected void generateChecksForPostcondition(MethodScope scope2, CodeStream codeStream) {
		/* empty */
	}
	// <jml-end id="0a1" />
