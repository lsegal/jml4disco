...
public void traverse(ASTVisitor visitor, BlockScope blockScope) {
	...
	//<jml-start id="2" />
	protected void generateNullityTest(CodeStream codeStream, BlockScope currentScope) {
		// empty
	}
	public boolean isDeclaredNonNull() {
		return this.expression.isDeclaredNonNull();
	}
	public boolean isDeclaredMonoNonNull() {
		return this.expression.isDeclaredMonoNonNull();
	}
	// <jml-end id="2" />
