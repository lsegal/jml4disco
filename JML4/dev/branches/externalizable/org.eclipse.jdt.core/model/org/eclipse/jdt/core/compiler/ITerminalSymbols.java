...
public interface ITerminalSymbols {
	...
	// <jml-start id="?" />
	int
	TokenNamerequires = 96,
	TokenNameensures = 119,
	TokenNamepure = 123,
	TokenNamenon_null_by_default = 77,
	TokenNamenullable_by_default = 78,
	TokenNamenon_null = 76,
	TokenNamejml_assert = 90,
	TokenNamenullable = 79;
	// <jml-start id="?" />
