...
public class WhileStatement extends Statement {
	...
	public void generateCode(BlockScope currentScope, CodeStream codeStream) {
		...
		this.emitCodeBeforeContinueLabel(currentScope, codeStream);
		...
		boolean isConditionOptimizedFalse = cst != Constant.NotAConstant && cst.booleanValue() == false;
		if (isConditionOptimizedFalse) {
			//<jml-start id="jml.loop-anotations" />
//			if (! DesugarLoopVisitor.useNewLoopSemantics)
				this.checkLoopInvariant(currentScope, codeStream);
			//<jml-end id="jml.loop-anotations" />
...
//				this.checkLoopInvariant(currentScope, codeStream);
		...
		if (continueLabel != null) {
			continueLabel.place();
			//<jml-start id="jml.loop-annotations" />
			this.checkLoopVariant(currentScope, codeStream);
//			if (! DesugarLoopVisitor.useNewLoopSemantics)
				this.checkLoopInvariant(currentScope, codeStream);
			//<jml-end id="jml.loop-annotations" />
			condition.generateOptimizedBoolean(
				...
				true);
			//<jml-start id="jml.loop-annotations" />
			//fixme: the check here is too late, 
			//       since the jump is made in the above call to generateOptimizedBoolean
//			if (DesugarLoopVisitor.useNewLoopSemantics)
//				this.checkLoopInvariant(currentScope, codeStream);
			//<jml-end id="jml.loop-annotations" />
		}
...
//		this.checkLoopInvariant(currentScope, codeStream);
	...
	//<jml-start id="jml.loop-annotations" />
	protected void checkLoopInvariant(BlockScope currentScope, CodeStream codeStream) { /*empty*/ }	
	protected void checkLoopVariant(BlockScope currentScope, CodeStream codeStream) { /*empty*/ }
	protected void emitCodeBeforeContinueLabel(BlockScope currentScope, CodeStream codeStream) { /*empty*/ }
	//<jml-end id="jml.loop-annotations" />
