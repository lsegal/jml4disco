...
public class Boogie extends DefaultCompilerExtension {
	...
	private void process(Compiler compiler, CompilationUnitDeclaration unit) {
		BoogieVisitor boogie = new BoogieVisitor();
		System.out.println("BEGIN");
		unit.traverse(boogie, unit.scope);
		System.out.println(boogie.getResults());
		//compiler.problemReporter.jmlEsc2Error("hello world", 8, 12);  //$NON-NLS-1$
	}
